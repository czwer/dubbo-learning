...
（1.2）方式二：通过阿里云镜像下载，https://mirrors.aliyun.com/gradle/distributions/v8.14.0/gradle-8.14-bin.zip

    sdk install gradle 8.14 /path/to/your/gradle-8.14-bin.zip
...
（4）修改apache-zookeeper-3.9.3-bin/conf/zoo.cfg：
    ...
    dataDir=/path/to/your/apache-zookeeper-3.9.3-bin/data
    dataLogDir=/path/to/your/apache-zookeeper-3.9.3-bin/logs
（5）启动：
