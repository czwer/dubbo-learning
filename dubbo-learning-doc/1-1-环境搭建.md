...
（7）完整编译：
    ...
    ./gradlew -x test -x javadoc -x aggregatedJavadoc -x dokkatooGenerateModuleHtml -x documentationTest -x dokkatooGeneratePublicationHtml publishToMavenLocal --parallel
